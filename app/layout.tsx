  ...
  "@graph": [
    ...
    },
    {
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          "Storefront window cleaning",
          "Office and commercial building window cleaning",
          "Large and hard-to-reach window cleaning",
          "Custom-shaped and specialty glass cleaning",
        ].map((name) => ({
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
