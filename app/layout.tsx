  ...
  "@graph": [
    ...
    },
    {
      ...
      knowsAbout: [
        ...
        "Window cleaning frequency for commercial properties",
        "Interior window cleaning",
        "Exterior window cleaning",
        "Oversized and custom-shaped glass",
      ],
      hasOfferCatalog: {
        "@type": "OfferCatalog",
        name: "Recurring Commercial Window Cleaning Plans",
        itemListElement: [
          ...
          "One-time commercial window cleaning",
        ].map((name) => ({
          "@type": "Offer",
          itemOffered: {
            "@type": "Service",
